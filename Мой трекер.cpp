...
struct workout; // Структура тренировки
...
void stopwatch(int& sec, int& min, int& hour, int go, string name2); // Функция работы секундомера
void timer(int& sec, int& min, int& hour, int go, string name2); // Функция работы таймера
